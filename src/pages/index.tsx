          ...
          >
            ...
            <div className="space-y-16">
              {[
                ...
                {
                  title: "制作すること",
                  body: "ひとは生きていることそのことが制作であるはず。批評もまた制作。技術も制作。あらゆることに制作者として向き合う。「〜のひと」と固定されることへの抵抗。ソフトウェアを書き、文章を書き、写真を撮る。",
                  color: "bg-primary/10",
                  accent: "bg-primary",
                },
                {
                  title: "読むこと",
                  body: "歴史、哲学、アート、社会科学、サイエンス。ジャンルを横断しながら、概念を拾い集めて結びつける。日記を習慣的に書いている。読むことと書くことは同じ運動の表と裏。",
                ...
                {
                  title: "手触りのあるもの",
                  body: "美術館と博物館。現代作家のうつわ。江戸前鮨。歌舞伎。落語。公園の散歩。写真。語学。シーシャ。アマチュア無線。ソーシャルVR。小さな趣味を数え上げればきりがない。",
                  color: "bg-orange/10",
                  accent: "bg-orange",
                },
              ].map((item, i) => (
